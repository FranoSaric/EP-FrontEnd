...
import TableOfExams from "../components/exams/tableOfExams/TableOfExams";
import ExamForm from "../components/exams/examForm/ExamForm";
...
const Routes = [
  ...
  {
    path: "/administration/exams/examsManagement",
    name: "Exam Manager",
    component: TableOfExams,
    exact: true,
    claimValue: "exams.read",
  },
  {
    path: "/administration/exams/addExam",
    name: "Add Exam",
    component: ExamForm,
    exact: true,
    claimValue: "exams.manage",
  },
  {
    path: "/administration/exams/addExam/:examId",
    name: "Add Exam",
    component: ExamForm,
    exact: true,
    claimValue: "exams.manage",
