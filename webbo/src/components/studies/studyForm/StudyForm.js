...
function StudyForm() {
  ...
  return (
    <ContentWrapper
      link="/administration/studies/studiesManagement"
      title={isUpdate ? t("updateStudy") : t("addStudy")}
      size="small"
    >
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <InputField
            ...
            value={inputFieldValuesObject}
            valueHandler={handleChange}
            validationValues={validationMessageAndValidityObject["year"]}
          />
        </Grid>
        <Grid item xs={12}>
          <InputField
            ...
            value={inputFieldValuesObject}
            valueHandler={handleChange}
            validationValues={validationMessageAndValidityObject["cycle"]}
          />
        </Grid>
      </Grid>
