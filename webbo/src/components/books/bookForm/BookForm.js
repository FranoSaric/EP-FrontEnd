...
function BookForm() {
  ...
  return (
    <ContentWrapper
      link="/library/books/booksManagement"
      title={isUpdate ? t("updateBook") : t("addBook")}
      size="small"
    >
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <SelectField
            ...
            validationValues={validationMessageAndValidityObject["categoryFK"]}
            readonly={isUpdate}
          />
        </Grid>
        <Grid item xs={12}>
        ...
        <Grid item xs={12}>
          <InputField
            ...
            value={inputFieldValuesObject}
            valueHandler={handleChange}
            validationValues={validationMessageAndValidityObject["author"]}
          />
        </Grid>
        <Grid item xs={12}>
          <InputField
            ...
            value={inputFieldValuesObject}
            valueHandler={handleChange}
            validationValues={validationMessageAndValidityObject["barCode"]}
          />
        </Grid>
      </Grid>
