...
import DeletePermissionScope from "../apiRequests/DeletePermissionScope";
 ...
 */
function TableOfPermissionScope() {
    ...
    async function handleDelete() {
        if (type === "delete") {
            const model = {
                idPerimissionScope: ctx.itemId,
            };
            const data = await DeletePermissionScope(model);
    ...
    return (
        <React.Fragment>
            ...
            <TemplateForm title={t("permissionScopeManagement")} size="small">
                <DataTable
                    columns={newColumns}
...
export default TableOfPermissionScope;
