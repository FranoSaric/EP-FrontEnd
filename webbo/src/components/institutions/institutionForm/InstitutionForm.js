...
function InstitutionForm() {
	...
	return (
		<TemplateForm title={isUpdate ? t("updateInstitution") : t("addInstitution")}>
			<Grid container spacing={3}>
				...
				<Grid item xs={12}>
					<InputField
						...
						valueHandler={handleChange}
						validationValues={
							validationMessageAndValidityObject["address"]
						}
						required={true}
					/>
				</Grid>
				<Grid item xs={12}>
					<InputField
						...
						valueHandler={handleChange}
						validationValues={
							validationMessageAndValidityObject["giroAccount"]
						}
						required={true}
					/>
				</Grid>
				<Grid item xs={12}>
					<InputField
						...
						valueHandler={handleChange}
						validationValues={
							validationMessageAndValidityObject["contact"]
						}
						required={true}
					/>
				</Grid>
