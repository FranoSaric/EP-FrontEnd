...
function CourseForm() {
  ...
  return (
    <ContentWrapper
      link="/administration/courses/coursesManagement"
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6}>
          <InputField
            ...
            value={inputFieldValuesObject}
            valueHandler={handleChange}
            validationValues={validationMessageAndValidityObject["semester"]}
            required={true}
          />
        </Grid>
        <Grid item xs={12} sm={6}>
          <SelectField
            ...
            value={inputFieldValuesObject}
            valueHandler={handleChange}
            validationValues={validationMessageAndValidityObject["studyFK"]}
          />
        </Grid>
